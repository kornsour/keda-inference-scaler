// KEDA external-scaler contract (https://keda.sh/docs/latest/concepts/external-scalers/).
// KEDA's operator is the gRPC *client*; this service is the server.
...
const file_externalscaler_externalscaler_proto_rawDesc = "" +
	...
	"\n" +
	"GetMetrics\x12!.externalscaler.GetMetricsRequest\x1a\".externalscaler.GetMetricsResponse\"\x00B:Z8github.com/kornsour/keda-inference-scaler/externalscalerb\x06proto3"
